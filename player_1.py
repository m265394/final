...
class Player1(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image_hurt_idle = pygame.image.load("../assets/sprites/player_1_zombie_idle.png").convert()
        self.image_hurt_idle.set_colorkey((0, 0, 0))
        self.image_hurt_forward = pygame.image.load("../assets/sprites/player_1_zombie_walk.png").convert()
